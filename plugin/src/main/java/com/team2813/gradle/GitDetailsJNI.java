...
class GitDetailsJNI {
    private static class CorrectContext implements Context {
        ...
        CorrectContext() {
            ...
            applyHack = platform.getArchitecture().equals(EnumArchitecture.AARCH_64)
        ...
        @Override
        public String mapLibraryName(String name, boolean usePlatformPrefix, boolean usePlatformSuffix) {
